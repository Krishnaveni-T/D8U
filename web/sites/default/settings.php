 ...
 * @endcode
 */
$settings['hash_salt'] = 'MsFguPbtfxHpNttZFtMoZTBndzuInG9SHC1mWTvfMsN1PyFHF6fxXccq_bRdilNMBUproDH8-A';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal_web_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal_web_dd.inc';
}
// </DDSETTINGS>
